...
execute as @s[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~4.5 ~10.5 ~-2.5 0.1 0.1 0.1 0.5 8 normal
...
execute as @s[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~4.5 ~14.5 ~-1.5 0.1 0.1 0.1 0.5 8 normal
...
execute as @s[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~4.5 ~12.5 ~1.5 0.1 0.1 0.1 0.5 8 normal
execute as @s[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~4.5 ~13.5 ~1.5 0.1 0.1 0.1 0.5 8 normal
execute as @s[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~4.5 ~15.5 ~2.5 0.1 0.1 0.1 0.5 8 normal
