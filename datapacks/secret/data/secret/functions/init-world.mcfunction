...
setblock ~-3 ~-1 ~ minecraft:command_block{Command:"execute as @a[sort=nearest,limit=1,nbt={Inventory:[{id:'minecraft:written_book'}]}] run function secret:success"}
...
setblock ~ ~-1 ~ minecraft:command_block{Command:"execute as @a[sort=nearest,limit=1,nbt={Inventory:[{id:'minecraft:written_book'}]}] run function secret:reroll"}
...
setblock ~3 ~ ~ minecraft:lodestone
setblock ~3 ~1 ~ minecraft:polished_blackstone_button[face=floor]
setblock ~3 ~-1 ~ minecraft:command_block{Command:"execute as @a[sort=nearest,limit=1,nbt={Inventory:[{id:'minecraft:written_book'}]}] run function secret:fail"}
setblock ~3 ~-1 ~1 minecraft:reinforced_deepslate
