...
# Success command block
setblock ~-7 ~ ~-3 minecraft:command_block{Command:"execute as @a[sort=nearest,limit=1,nbt={Inventory:[{id:'minecraft:written_book'}]}] run function secret:success"}

# Reroll command block
setblock ~-7 ~ ~ minecraft:command_block{Command:"execute as @a[sort=nearest,limit=1,nbt={Inventory:[{id:'minecraft:written_book'}]}] run function secret:reroll"}

# Fail command block
setblock ~-7 ~ ~3 minecraft:command_block{Command:"execute as @a[sort=nearest,limit=1,nbt={Inventory:[{id:'minecraft:written_book'}]}] run function secret:fail"}
